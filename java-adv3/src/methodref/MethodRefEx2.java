...
public class MethodRefEx2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("staticMethod1 = " + staticMethod1.apply("Lee"));
        ...
        System.out.println("newPerson1 = " + newPerson1.apply("Lee").getName());
        System.out.println("newPerson2 = " + newPerson2.apply("Lee").getName());
    }
}
